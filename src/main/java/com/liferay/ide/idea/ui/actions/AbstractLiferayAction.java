...
public abstract class AbstractLiferayAction extends AnAction {
	...
	protected void configExcludeFolder() {
		VirtualFile projectDir = project.getBaseDir();

		projectDir.refresh(false, true);

		VirtualFile directoryToExclude = projectDir.findChild("bundles");

		if (!FileUtil.exist(directoryToExclude)) {
			return;
		}

		IntellijUtil.configExcludeFolder(project, directoryToExclude);
	}

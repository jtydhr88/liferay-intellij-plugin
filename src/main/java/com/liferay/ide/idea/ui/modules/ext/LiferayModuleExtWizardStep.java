...
public class LiferayModuleExtWizardStep extends ModuleWizardStep {
	...
	public LiferayModuleExtWizardStep(WizardContext wizardContext, LiferayModuleExtBuilder builder) {
		...
		KeyAdapter keyAdapter = new KeyAdapter() {
			...
			public void keyTyped(KeyEvent e) {
				//reset the selected source file when input changed
		...
		if (LiferayWorkspaceUtil.getTargetPlatformVersion(_project) != null) {
			...
			_originalModuleVersion.addKeyListener(keyAdapter);
		}
	}
	...
	public void updateDataModel() {
		...
		_builder.setOverrideFilesPanel(_overrideFilesPanel);
	}
	...
	private LibraryData _getCurrentArtifact() {
	...
	private ComboBoxEditor _getEditor() {
		return _originalModuleName.getEditor();
	}
	...
	private void _insertOriginalModuleNames(boolean clear) {
		_targetPlatformArtifacts = GradleUtil.getTargetPlatformArtifacts(_project);
